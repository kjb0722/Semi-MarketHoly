...
public class ProductDao {
	...
	public ArrayList<ProductDto> getNBSList(int startRow, int endRow, String filter) {
		...
		try {
			...
			if (filter.equals("new")) {
				 ...
				 * "where rnum>=? and rnum<=? " + "order by reg_date desc";
				 */
			}
			pstmt = con.prepareStatement(sql);
	...
	public int delProd(int pnum) {
		...
		try {
			...
			String sql5 = "delete from cart where pnum = ?";
			pstmt5 = con.prepareStatement(sql5);
			pstmt5.setInt(1, pnum);
			pstmt5.executeUpdate();
			
			String sql4 = "delete from order_product where pnum = ?";
			pstmt4 = con.prepareStatement(sql4);
			pstmt4.setInt(1, pnum);
			pstmt4.executeUpdate();
			
			String sql3 = "delete from sale where pnum = ?";
			pstmt3 = con.prepareStatement(sql3);
			pstmt3.setInt(1, pnum);
			pstmt3.executeUpdate();
			
			String sql2 = "delete from qna where pnum = ?";
