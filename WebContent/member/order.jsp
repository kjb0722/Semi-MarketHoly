...
<div id="3" class="container" style='width:1000px;'>
	...
	<h1 style=text-align:center;>주문자 정보</h1>
		...
		<p>보내는 사람*</p><input type="text" id="sender" value="${MemberDto.getName}">
		<br>
		<p>휴대폰*</p> <input type="text" name="phone" value="${MemberDto.getPhone}">
		<br>
		<p>이메일*</p> <input type="text" id="email" value="${MemberDto.getEmail}">
...
<div id="8" class="container" style='width:1000px;'>
	...
	상품할인금액 :500원<br>
	배송비 :2500원<br>
	적립금사용 :<input type="text" id="point" value="${CartDto.getPoint}"><br>
	<br>
	최종결제금액 :<input type="text" id="total">
	<br>
